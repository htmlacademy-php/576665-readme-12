                    ...
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        <?php foreach ($post_types as $post_type): ?>
                            <li class="adding-post__tabs-item filters__item">
                                <a class="adding-post__tabs-link filters__button filters__button--<?=$post_type['class']?> tabs__item <?= $active_post_type_id === $post_type['id'] ? 'filters__button--active tabs__item--active' : ''?> button" href="/add.php?post_type=<?=$post_type['id']?>">
                                ...
                                <div class="form__text-inputs">
                                   ...
                                   <?=$adding_post_content ?>
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        ...
                                        <div class="form__input-section <?= !empty($errors['tags'] ? $errors['tags'] : '') ?>">
