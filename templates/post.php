                ...
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        <div class="post__buttons">
                            ...
                            <a class="post__indicator post__indicator--comments button" href="#comment"
                               title="Комментарии">
                        ...
                        <form class="comments__form form" method="post">
                            ...
                            <div class="form__input-section <?= (!empty($errors)) ? 'form__input-section--error' : '' ?>">
                                <textarea class="comments__textarea form__textarea form__input"
                                          placeholder="Ваш комментарий" id="comment"
                                          name="comment"><?= !empty($new_comment['comment']) ? esc($new_comment['comment']) : '' ?></textarea>
                                            ...
                                            <div class="comments__info">
                                                <div class="comments__name-wrapper">
                                                    ...
                                                    <time class="comments__time"
                                                          datetime="<?= $comment['date'] ?>"><?= get_relative_date($comment['date']) ?></time>
                                                </div>
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        <div class="post-details__avatar user__avatar">
                            <a class="post-details__avatar-link user__avatar-link"
                               href="profile.php?user_id=<?= $author_data['id'] ?>">
                        ...
                        <div class="post-details__name-wrapper user__name-wrapper">
                            ...
                            <time class="post-details__time user__time"
                                  datetime="$user_data['registered']"><?= get_relative_date($author_data['registered']) ?>
                                назад
                            </time>
                        </div>
                    </div>
                    <div class="post-details__rating user__rating">
                        ...
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            ...
                            <span class="post-details__rating-text user__rating-text">
                                <?= get_noun_plural_form($author_data['posts_count'], 'публикация', 'публикации',
                                    'публикаций'); ?>
                            </span>
                        </p>
                    </div>
                        ...
                        <div class="post-details__user-buttons user__buttons">
                            ...
                            <?php if ($author_data['is_following']): ?>
                                <a class="user__button user__button--writing button button--green"
                                   href="/messages.php?contact_id=<?= $author_data['id'] ?> ">Сообщение</a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
